...
var (
	CS               = func(cs ...Cond) []Cond { return cs }
	Eq               = func(c Column, v interface{}) Cond { return &eq{value: v, op: "", column: c} }
	NotEq            = func(c Column, v interface{}) Cond { return &notEq{value: v, op: "", column: c} }
	Like             = func(c Column, v interface{}) Cond { return &like{value: v, op: "", column: c} }
	NotLike          = func(c Column, v interface{}) Cond { return &notLike{value: v, op: "", column: c} }
	LeftLike         = func(c Column, v interface{}) Cond { return &leftLike{value: v, op: "", column: c} }
	NotLeftLike      = func(c Column, v interface{}) Cond { return &notLeftLike{value: v, op: "", column: c} }
	RightLike        = func(c Column, v interface{}) Cond { return &rightLike{value: v, op: "", column: c} }
	NotRightLike     = func(c Column, v interface{}) Cond { return &notRightLike{value: v, op: "", column: c} }
	Instr            = func(c Column, v interface{}) Cond { return &instr{value: v, op: "", column: c} }
	NotInstr         = func(c Column, v interface{}) Cond { return &notInstr{value: v, op: "", column: c} }
	Gt               = func(c Column, v interface{}) Cond { return &gt{value: v, op: "", column: c} }
	NotGt            = func(c Column, v interface{}) Cond { return &notGt{value: v, op: "", column: c} }
	GtEq             = func(c Column, v interface{}) Cond { return &gtEq{value: v, op: "", column: c} }
	NotGtEq          = func(c Column, v interface{}) Cond { return &notGtEq{value: v, op: "", column: c} }
	Lt               = func(c Column, v interface{}) Cond { return &lt{value: v, op: "", column: c} }
	NotLt            = func(c Column, v interface{}) Cond { return &notLt{value: v, op: "", column: c} }
	LtEq             = func(c Column, v interface{}) Cond { return &ltEq{value: v, op: "", column: c} }
	NotLtEq          = func(c Column, v interface{}) Cond { return &notLtEq{value: v, op: "", column: c} }
	BetweenAnd       = func(c Column, l, r interface{}) Cond { return &betweenAnd{left: l, right: r, op: "", column: c} }
	NotBetweenAnd    = func(c Column, l, r interface{}) Cond { return &notBetweenAnd{left: l, right: r, op: "", column: c} }
	In               = func(c Column, vs ...interface{}) Cond { return &in{values: vs, op: "", column: c} }
	NotIn            = func(c Column, vs ...interface{}) Cond { return &notIn{values: vs, op: "", column: c} }
